...
namespace SaharovNik_KT_42_20.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public IActionResult CreateGroup([FromBody] SaharovNik_KT_42_20.Models.Group group)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public IActionResult DeleteGroup(string groupName, SaharovNik_KT_42_20.Models.Group updatedGroup)
        {
            var existingGroup = _context.Groups.FirstOrDefault(g => g.GroupName == groupName);
